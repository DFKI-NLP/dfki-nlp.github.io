...
Two papers from researchers in the DFKI-NLP group have been accepted as Main papers at the [2026 Conference on Empirical Methods in Natural Language Processing (EMNLP 2026)](https://2026.emnlp.org/), and one as a Findings paper. In addition, one paper was accepted to the [BlackboxNLP workshop](https://blackboxnlp.github.io/2026/) as well as 3 more papers from our group's [Speech and Language Technology lab](https://www.dfki.de/en/web/research/research-departments/speech-and-language-technology). EMNLP will take place October 24 –29 in Budapest, Hungary. 
